...
echo -e "  2. 编辑 ${BLUE}${DISPLAY_PREFIX}/codex/任务池.md${NC} — 填里程碑、任务和 Won't 列表"
echo -e "  3. 编辑 ${BLUE}${DISPLAY_PREFIX}/codex/架构.md${NC} — 填模块地图和依赖"
echo -e "  4. 为模块补齐 ${BLUE}${DISPLAY_PREFIX}/codex/模块/${NC} 下的文档"
echo ""
echo "日常命令："
